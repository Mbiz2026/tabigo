...
- `icon-192.png` / `icon-512.png` / `apple-touch-icon.png` = アプリアイコン(ティール地に白スーツケース)
...
- 2026-07-12: GitHub Pages移行(https://mbiz2026.github.io/tabigo/)、PWA完成(アイコン・全画面起動・オフライン対応)
- 2026-07-12: コース選択を追加(ミックス/はなす/きく/ドライブ)。ドライブ=画面を見ない自動音声ドリル(日本語→間→英語×2、SRS非干渉、wake lock付き)
- 2026-07-16: ドライブを無限再生化(終了ボタンまで・全教材1周→シャッフル・TTS固まり対策の番犬+resume)。通常セッションは時間まで教材を自動補充(新規増量4-5枚)
